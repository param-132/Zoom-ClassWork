...
if __name__ == '__main__':
    wallet = []
    wallet.append(CreditCard('THOR','HDFC Bank','1234 7890 5074 3114',58800))
    wallet.append(CreditCard( 'IRONMAN' , 'Federal Bank' ,'3656 5400 9685 4512' , 45200))
    wallet.append(CreditCard( 'CaptainAmerica' , 'HDFC Bank' , '4165 8597 6295 3256' , 51000))
    for c in range(3):
